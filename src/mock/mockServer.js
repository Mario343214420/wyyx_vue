...
//返回detail页数据的接口
Mock.mock('/detail', {code:0, detail: shiwu_data})//返回detail页数据的接口
Mock.mock('/detailtuijian', {code:0, detail: shiwutuijian_data})
//返回分类页nav数据
Mock.mock('/nav', {code:0, nav: data_nav})


Mock.mock('/kingKongModule',{code:0,kingKongModule:shouye_data.kingKongModule})
